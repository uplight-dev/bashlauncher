...
aliases() {
	...
	alias blup="(cd $SCRIPTS0_SYS; echo Current DIR=$PWD; echo Committing and Pushing started; echo -e "\n\n"; git add .; git commit -am 'updated scripts'; git push origin master; echo -e "\n\n"; echo Push Complete!)"
}
