...
aliases() {
	...
	alias blup="(cd $SCRIPTS0_SYS; echo Current DIR=$PWD; echo Pulling changes ...; echo -e \"Committing and Pushing started\"; git add .; git commit -am 'updated scripts'; git push origin master; echo -e \"\n\nPush Complete!\")"
}
